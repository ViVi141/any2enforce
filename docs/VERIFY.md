...
| 21 | 字符串转义 `\uXXXX`/`\xXX` | 语料极少（1/6 文件）| `\t`/`\n` 已定案合法；`\u0041`/`\x41`/`\0` 待 Workbench 实测（P08） |
| 24 | 浮点科学计数字面量 | 首轮 Workbench 实测：`1e+30`/`1.0e30` ✅；**`1E30`（大写 E、无小数点、无符号）❌ 非法**；`1e30`/`1.0E30` 待测（P05） | `repr()` 输出（恒小写 e 带符号）安全 |

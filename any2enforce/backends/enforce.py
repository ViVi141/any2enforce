...
class EnforceBackend:
    ...
    def emit(self, mod: Module) -> str:
        self.lines = []
        self.indent = 0
        # Apply per-module namespace prefix (set by bundle resolver for
        # disambiguation; empty for single-file mode).
        self.prefix = (self.naming.get("prefix", "") or "") + (mod.ns_prefix or "")
